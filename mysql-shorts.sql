...
SELECT @tableList := GROUP_CONCAT(`table_name`) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'rpm_simpletire' AND TABLE_NAME LIKE '%order%' OR TABLE_NAME LIKE '%product%';
